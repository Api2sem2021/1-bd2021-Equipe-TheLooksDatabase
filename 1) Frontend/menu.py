...
<perfildeinvestidor@FloatLayout>:
...
<simuladordejuroscompostos@FloatLayout>:
    MDFloatingActionButton:
        icon: "images\icone.png"
        user_font_size: "64sp"
        pos_hint: {"center_x": .1, "center_y": .9}
...
<comparativoentrecorretoras@FloatLayout>:
    MDFloatingActionButton:
        icon: "images\icone.png"
        user_font_size: "64sp"
        pos_hint: {"center_x": .1, "center_y": .9}
...
<conversãodetaxadecambio@FloatLayout>:
    MDFloatingActionButton:
        icon: "images\icone.png"
        user_font_size: "64sp"
        pos_hint: {"center_x": .1, "center_y": .9}
...
class perfildeinvestidor:
    pass

class noticias:
    pass

class simuladordejuroscompostos:
    pass

class comparativoentrecorretoras:
    pass
